namespace Gestion_Etudiants.Models.Repositories
{
	public class SchoolRepository : ISchoolRepository
	{
		...
		{
			School schoolToDelete = context.Schools.Find(id);
			if (schoolToDelete != null)
			{
				context.Schools.Remove(schoolToDelete);
				context.SaveChanges();
			}
		}


		public void Delete(object school, int id)
		{
